...
*/
  ...
  Stream<List<Product>> productStream() => _service.collectionStream(
      path: APIPath.pros(),
      builder: (data, documentID) => Product.fromMap(data, documentID));
  Stream<List<Product>> myProduct() => _service.myProductStream(
      path: APIPath.pros(),
      builder: (data, documentID) => Product.fromMap(data, documentID));
  Stream<List<Product>> myFav(l) => _service.favoriteStream(
      path: APIPath.pros(),
      list: l,
      builder: (data, documentID) => Product.fromMap(data, documentID));
  Stream<List<Job>> jobStream() => _service.jobStream(
      path: APIPath.job(), builder: (data) => Job.fromMap(data));

  Stream<List<Shop>> shopThreadStream() => _service.shopThreadStream(
      path: APIPath.shop(), builder: (data) => Shop.fromMap(data));
  Stream<List<Shop>> shopSparepartsStream() => _service.shopSparepartsStream(
      path: APIPath.shop(), builder: (data) => Shop.fromMap(data));
}
